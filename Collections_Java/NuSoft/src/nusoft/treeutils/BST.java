...
//Description: Modify the Binary Tree Sort

package nusoft.treeutils;
...
private class PostorderIterator implements Iterator<E> {
    private java.util.Stack<TreeNode<E>> stack1 = new java.util.Stack<>();
    private java.util.Stack<TreeNode<E>> stack2 = new java.util.Stack<>();
