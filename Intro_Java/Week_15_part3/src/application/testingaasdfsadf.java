	...
	public class testingaasdfsadf extends Application
	{
	   ...
	   public void start(Stage primaryStage)
	   {
	      ...
	      listView.getItems().addAll("Bethany Miller", "Katrina Miller", "Steve Smith", "Will Addams");
	      ...
	      Button button2 = new Button("Open Contact");
	      Button button3 = new Button("Delete Contact");
