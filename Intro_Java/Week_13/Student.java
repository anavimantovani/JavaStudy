/**
   ...
   this class.
*/
//cannot instantiate but you can subclass(inherit -extends) abstract classes
public abstract class Student
{
   ...
   */
   // is going to be overridden, so i doesn't need a body
   //no body, only header, needs to override abstract methods
   // - shorter code, no redundancy, avoid code duplication...
